...
## Critérios de aceite
- [ ] Checklist de validação em VM limpa versionado no repositório
- [ ] Processo de aprovação da release exige checklist 100% concluído
- [ ] Evidências da validação (logs/screenshots) anexadas ao fluxo de release
- [ ] Release não é marcada como pronta sem aprovação desse gate
